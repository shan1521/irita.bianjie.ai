	...
	<div class="home_content_wrapper">
			...
			<div class="irita_what_content">
				...
				<div class="irita_description">
					...
					<div class="characteristic">
						<span class="characteristic_item" v-for="(item,index) in iritaDescription.characteristic"
							  :key="index">{{ item.text }}</span>
					</div>
					<p class="description_article" v-for="(item,index) in iritaDescription.descriptionArticle"
		...
		<div class="home_product_content">
			<div class="product_content">
				...
				<div class="product_img">
					<img src="/home/chanpinjiagou_image.png" alt="">
				</div>
			</div>
		</div>
		<!-- IRITA 核心技术优势 -->
		<div class="home_advantage_content">
			...
			<div class="advantage_content">
				...
				<div class="more">
					<a class="more_content" href="https://irita.bianjie.ai/docs/" target="_blank"
			...
			<div class="productionline_content">
				...
				<div class="production_line_content">
					<ul class="production_line">
						<div class="line_item_wrapper" ref="lineItemWrapper" :style="productionLineTop(index)"
							 @mouseenter="hoverFn(item.id)" @mouseleave="leaveFn(item.id)"
							 v-for="(item,index) in productionLine.productionList" :key="item.id">
							<li class="line_item">
					...
					<div class="production_line_img">
						<img ref="productionLineImg" v-for="(item,index) in productionLine.productionLineImg"
							 :key="index" :src="differentLineImg(item.lineImgName)" alt="" class="irita_image">
					</div>
				</div>
			</div>
		</div>
				...
				<ul class="opencommunity_list">
					<li class="open_item" v-for="(item,index) in openCommunity.list" :key="index"
						...
						<div class="item_wrapper" ref="openWrapper" :style="differentOpenImg(item.blogImgName)">
							...
							<div class="more">
								<a v-show="item.target === '_blank'" :href="item.link" :target="item.target"
								   class="more_content"
								>
									<span class="more_text">了解更多</span>
									<i class="iconfont icon-turnto"></i>
								...
								<router-link v-show="item.target === '_self'"
											 @click.native="commitFn(item.routingLevel,index)" :to="item.link" replace
											 class="more_content"
								>
									<span class="more_text">了解更多</span>
									<i class="iconfont icon-turnto"></i>

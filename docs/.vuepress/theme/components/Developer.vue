  ...
  <div class="developer_container">
    ...
    <div class="developer_middle_top">
      <div class="developer_middle_top_wrap">
        <span class="developer_middle_top_top"> 您能基于 IRITA 开发什么? </span>
          ...
          <div class="developer_middle_top_right">
            <div class="developer_middle_top_right_top">
              <div class="developer_middle_top_right_top_item">
                <span class="developer_middle_top_right_top_title">
                  跨链服务平台
                </span>
            ...
            <a
              ...
              target="_blank"
            >
              <span class="developer_middle_top_right_know"> 了解更多 </span>
              <img
    ...
    <div class="developer_middle_bottom">
      <div class="developer_middle_bottom_wrap">
        <div class="developer_title_content">
          <span class="developer_middle_bottom_title"> 为什么选择 IRITA </span>
        </div>
        <div class="developer_middle_bottom_content">
          <div class="developer_middle_bottom_item">
            ...
            />
            <span class="developer_middle_bottom_item_title"> SDKs </span>
            <span class="developer_middle_bottom_item_content _no_border">
              多种语言的开发工具
            </span>
  ...
  .developer_top {
    ...
    background: url('../assets/devoloper_top_bg.png') no-repeat center / cover;
		...
		@media (max-width: 768px) {
			height: 28rem;
			background: url('../assets/blog_bg_768.png') no-repeat center / cover;

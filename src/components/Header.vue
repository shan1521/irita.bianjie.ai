...
<!--						<div class="second_menu_first" v-if="index == 1">
							<ul class="second_production_menu" @click="updatenavigationIndex(index)" v-if="flShowProductionSecondMenu"  @mouseleave="hideSecondMenu()">
								...
								&lt;!&ndash; <li><router-link :to="`/products/irisnet`">IRISnet</router-link></li> &ndash;&gt;
								<li><router-link :to="`/products/iritaexpect`">IRISnet</router-link></li>
							</ul>
						</div>
...
<!--	                <router-link class="download_style" :to="`/download`" target="_blank">了解更多 <img style="width: 0.14rem" src="data:image/png;base64,"></router-link>-->
		...
		<div class="header_mobile_content" v-if="flShowMobileMenu">
			<ul class="header_mobile_list_content">
				...
				<li class="header_mobile_list_button" @click="changeRouter(`/docs`)"><a href="https://irita.bianjie.ai/docs" rel="noreferrer noopener" target="_blank">技术文档</a></li>
			</ul>
		</div>
	</div>
</template>
